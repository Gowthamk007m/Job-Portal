...
if (jQuery("#apex-line-area").length) {
    options = {
        ...
        colors: ["#827af3", "#fbc647", "#34c38f"],
        series: [
			{
                name: "New Users",
                data: [15, 25, 20, 30, 35, 40, 45, 50, 55, 90] // Dummy data for New Users for 10 months
            },
            {
                name: "User Profiles",
                data: [30, 40, 25, 45, 55, 35, 50, 45, 55, 80] // Dummy data for User Profiles for 10 months
            },
            {
                name: "Employer Profiles",
                data: [20, 35, 30, 50, 40, 45, 55, 50, 40, 20] // Dummy data for Employer Profiles for 10 months
            },
        ...
        xaxis: {
            ...
            categories: [
                ...
                "2023-09-01T00:00:00",
                "2023-10-01T00:00:00"
            ] // Dummy categories for 10 months
        },
        tooltip: {
            x: {
                format: "dd/MM/yy HH:mm"
